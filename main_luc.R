...
gg_lu <- ggplot() +
  ...
  scale_fill_manual(values = c("1"="#129912", "2"="#B8AF4F", "3"="#E974ED", "4"="#FFFFB2","5"="blue", "6"="#D5D5E5"), na.value=NA, 
                      name = "LUC", labels = c("Forest", "Grassland", "Cropland", "Pasture", "Water", "Other"))+

...
#main_lu
rents <- raster(file.path(raster_dir,"nearestPortCost.tif"))
...
#convert to ha
rents_ha <-rents_m_p#(rents_m_p/6.25)-870
...
gg_rents <- ggplot() +
  ...
  scale_fill_viridis_c( name="Transport cost\nin US$/ton", na.value = NA)+
...
gg_rents
write_rds(gg_rents, file.path(out,"ggplots","gg_nearestPort_Cost.rds"))
ggsave (file.path(out, "map_nearestPort_Cost.png"))
